...
INSERT INTO lagang_hr.countries
VALUES (
	'IT',
	'Italy',
	1
...
INSERT INTO lagang_hr.locations
VALUES (
	1000,
...
INSERT INTO lagang_hr.departments
VALUES (
	10,
	'Administration',
	200,
...
INSERT INTO lagang_hr.employees
VALUES (
	100,
	'Steven',
	'King',
...
INSERT INTO lagang_hr.job_history
VALUES (
	102,
	TO_DATE('13-Jan-1993', '%d-%M-%Y'),
...
ALTER TABLE lagang_hr.countries ADD FOREIGN KEY (region_id) REFERENCES lagang_hr.regions(region_id);
ALTER TABLE lagang_hr.locations ADD FOREIGN KEY (country_id) REFERENCES lagang_hr.countries(country_id);
ALTER TABLE lagang_hr.departments ADD FOREIGN KEY (location_id) REFERENCES lagang_hr.locations(location_id);
ALTER TABLE lagang_hr.employees ADD FOREIGN KEY (job_id) REFERENCES lagang_hr.jobs(job_id);
ALTER TABLE lagang_hr.employees ADD FOREIGN KEY (department_id) REFERENCES lagang_hr.departments(department_id);
ALTER TABLE lagang_hr.employees ADD FOREIGN KEY (manager_id) REFERENCES lagang_hr.employees(employee_id);
ALTER TABLE lagang_hr.departments ADD FOREIGN KEY (manager_id) REFERENCES lagang_hr.employees (employee_id);
ALTER TABLE lagang_hr.job_history ADD FOREIGN KEY (employee_id) REFERENCES lagang_hr.employees(employee_id);
ALTER TABLE lagang_hr.job_history ADD FOREIGN KEY (job_id) REFERENCES lagang_hr.jobs(job_id);
ALTER TABLE lagang_hr.job_history ADD FOREIGN KEY (department_id) REFERENCES lagang_hr.departments(department_id);